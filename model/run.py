...
def main():
    ...
    metadata = {"schema_version": SCHEMA_VERSION, "season": 2025, "source": source,
                ...
                "player_baseline_definition": "Earlier-training same-role means for gold share, damage share, DPM and vision/min; player summaries average these references over evaluated games with observed values. Radar impact reference is zero (on expected DPM).",
