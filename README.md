...
[Original proposal](proposal.md) · [Dataset and frontend contract](data/README.md) · [Model and validation](model/README.md) · [Historical portraits and logos](data/img/README.md)
